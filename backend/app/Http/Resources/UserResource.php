...
//        return parent::toArray($request);
    ...
    public function getList(): array
    {
        if($this->getNameClass() == (new Client())->getNameClass()) {
            ...
            return ['username' => 'userName', 'fullname' => 'fullName', 'phonenumber' => 'phoneNumber', 'last_activity' => 'lastActivity', 'img', 'roleid' => 'roleId', 'role', 'language', 'job_title' => 'jobTitle', 'pay_frequency' => 'payFrequency', 'currency', 'amount', 'address_line_1' => 'addressLine1', 'address_line_2' => 'addressLine2', 'city', 'state', 'zip', 'country', 'summary'];
        }
