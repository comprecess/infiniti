...
*/
        ...
        $prompt = 'В поле текст [текст] описаны основне требование для тебя и что пользователь хочет получить. Определи на каком языке написан [текст] и дай ответ на том же языке. Не пиши какой язык. ';
        $block['текст'] = $chatGPT->message;
