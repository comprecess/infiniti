...
class Catalog extends Seeder
{
    ...
    public function setCatalog()
    {
        ...
        $prop = [
            ...
            ['name' => 'Graduation', 'id_name' => 'graduation', 'type' => 'string'],
        ];
