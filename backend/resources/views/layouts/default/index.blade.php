<!DOCTYPE html>
<html lang="en" @if(@$font_size) class="{{$font_size}}" @endif>
<head>
    <meta charset="utf-8">
    <title>
        {$_title}
    ...
    <link rel="icon" href="{{url('theme/default/img/system/icon-32x32.png')}}" sizes="32x32" />
    <link rel="icon" href="{{url('theme/default/img/system/icon-192x192.png')}}" sizes="192x192" />
    <link rel="apple-touch-icon" href="{{url('theme/default/img/system/icon-180x180.png')}}" />
    <meta name="msapplication-TileImage" content="{{url('theme/default/img/system/icon-270x270.png')}}" />


    @if(App::environment('local'))

    @if(config('app.rtl'))
    <link id="css_app" rel="stylesheet" media="screen, print" href="{{url('theme/default/css/app-rtl.min.css')}}">
    @else
    <link id="css_app" rel="stylesheet" media="screen, print" href="{{url('theme/default/css/app.min.css')}}">
    @endif
