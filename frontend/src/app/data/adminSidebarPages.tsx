...
export const adminSidebarPages = [
  ...
  },
  {
    ...
    icon: <ProfileIcon />,
    openPaths: [
      { id: 0, title: 'Add Customer' },
      { id: 1, title: 'List Customer' },
  ...
  },
  {
    ...
    icon: <AccountingIcon />,
    openPaths: [
      { id: 0, title: 'New Deposit' },
      { id: 1, title: 'New Expense' },
      { id: 2, title: 'Transfer' },
      { id: 3, title: 'Bills' },
      { id: 4, title: 'View Transactions' },
      { id: 5, title: 'Uncleared Transactions' },
      { id: 6, title: 'Accounts' },
      { id: 7, title: 'New Account' },
      { id: 8, title: 'Assets' },
    ],
