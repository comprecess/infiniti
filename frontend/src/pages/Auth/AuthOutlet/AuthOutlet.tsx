        ...
        <div className={styles.wrapperLeft}>
          <div className={styles.greetings}>
            ...
            <span className={styles.description}>
              We’re decentralized IT teams, built to move fast and deliver
              results. We help our residents grow, build products for the
              global market, and guide our clients toward their financial
              goals — as efficiently as possible.
            </span>
            <span className={styles.description}>
              Think of us as your product incubator — focused, flexible,
              and fully digital.
            </span>
            <span className={styles.description}>
